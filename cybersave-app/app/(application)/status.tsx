  ...
  if (isInProgress) {
    ...
    return (
      <View style={styles.flex}>
        ...
        {/* Status banner */}
        <View style={styles.statusBannerWrap}>
...
const styles = StyleSheet.create({
  ...
  bodyScroll: { flex: 1 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: spacing.md, backgroundColor: '#F8FAFC' },
  ...
  dotCurrent: { backgroundColor: '#F59E0B', borderColor: '#F59E0B' },
  dotPending: { backgroundColor: '#FFFFFF', borderColor: '#CBD5E1' },
  line: { width: 2, flex: 1, backgroundColor: '#E2E8F0', marginVertical: 3, minHeight: 24 },
  lineDone: { backgroundColor: '#16A34A' },
  timelineContent: { flex: 1, paddingBottom: spacing.md },
  timelineLabel: { fontSize: 14, fontWeight: '700', color: '#64748B' },
  timelineLabelDone: { color: '#0F172A' },
  timelineLabelCurrent: { color: '#F59E0B', fontWeight: '800' },
  timelineLabelPending: { color: '#94A3B8' },
  timelineTime: { fontSize: 12, color: '#64748B', fontWeight: '600', marginTop: 2 },
  timelineEst: { fontSize: 12, color: '#F59E0B', fontWeight: '700', marginTop: 2 },
