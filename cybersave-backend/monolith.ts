...
import documentApp from './services/document-service/src/app';
import paymentApp from './services/payment-service/src/app';
import notificationApp from './services/notification-service/src/app';
import supportApp from './services/support-service/src/app';

import { startDraftReminderCron } from './services/application-service/src/utils/draftReminder';
...
app.use((req, res, next) => {
  ...
  // Public service read (GET /api/v1/services or /api/v1/services/:id)
...
// Mount the services as sub-apps
app.use(authApp);
app.use(applicationApp);
app.use(documentApp);
app.use(paymentApp);
