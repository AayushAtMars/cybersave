...
const services: Record<string, string> = {
  ...
  '/api/v1/services': process.env.APPLICATION_SERVICE_URL!,
  '/api/v1/applications': process.env.APPLICATION_SERVICE_URL!,
  '/api/v1/documents': process.env.DOCUMENT_SERVICE_URL!,
  '/api/v1/payments': process.env.PAYMENT_SERVICE_URL!,
  '/api/v1/notifications': process.env.NOTIFICATION_SERVICE_URL!,
  '/api/v1/support': process.env.SUPPORT_SERVICE_URL!,
};
